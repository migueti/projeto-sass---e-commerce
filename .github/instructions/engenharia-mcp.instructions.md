...
description: "Use when analyzing, reviewing, refactoring, debugging, or improving code and engineering practices in this workspace. Always coordinate Context7, Sequential Thinking, and engenharia-local when this instruction is invoked."
---
# Engenharia de Código com MCPs

- Como esta instrução é invocada explicitamente pelo usuário, trate a ativação dos MCPs como pré-condição: no início de cada tarefa, verifique Context7, Sequential Thinking e engenharia-local antes de analisar ou editar qualquer arquivo.
